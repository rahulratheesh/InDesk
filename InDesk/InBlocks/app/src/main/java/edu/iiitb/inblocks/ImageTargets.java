...
public class ImageTargets extends Activity implements SampleApplicationControl {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if ( getIntent() != null && getIntent().hasExtra("command_buffer")) {
            mCommandBuffer = new ArrayList<String>();
            mCommandBuffer = getIntent().getStringArrayListExtra("command_buffer");
        }
    ...
    private void loadTextures()
    {
        ...
        mTextures.add(Texture.loadTextureFromApk("TextureInBot.png", getAssets()));
    }
...
//            setSampleAppMenuSettings();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.image_targets, menu);
        return true;
    }
    ...
    public ArrayList<String> getmCommandBuffer()
    {
