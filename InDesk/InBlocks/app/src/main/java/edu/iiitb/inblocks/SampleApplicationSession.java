...
public class SampleApplicationSession implements Vuforia.UpdateCallbackInterface
{
    ...
    private static final String LOGTAG = "SampleApplicationSession";
    ...
    // and the Android onDestroy() life cycle event.
    // If the application is destroyed while a data set is still being loaded,
    // then we wait for the loading operation to finish before shutting down Vuforia
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            synchronized (mShutdownLock)
            {
                ...
                do
                {
                    ...
                    // Then it proceeds to the next step and reports
        ...
        {
            // Do something with the progress value "values[0]",
            // e.g. update splash screen, progress bar, etc.
        }
